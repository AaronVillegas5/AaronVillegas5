...
### Macro Data Pipeline
Engineered an automated Python ETL pipeline designed to handle large-scale time-series data. The pipeline dynamically ingests over 9 million rows of data from the FRED and Open-Meteo APIs, processes it, and routes it into PostgreSQL, Snowflake, and BigQuery for downstream analytics.

### Retail & Sales Analytics
Developed comprehensive data models analyzing Walmart sales data to identify trends, forecast replenishment needs, analyze volatility, and optimize supply chain visibility. 
